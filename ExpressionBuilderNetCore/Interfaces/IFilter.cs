...
namespace ExpressionBuilderNetCore.Interfaces
{
    ...
    public interface IFilter
    {
        ...
        IFilterStatementConnection By(string propertyId, ICondition operation);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IFilterStatementConnection By(string propertyId, ICondition operation, Connector connector);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value);
        ...
        /// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, Connector connector);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, TPropertyType value2);
        ...
        /// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, TPropertyType value2, Connector connector);
