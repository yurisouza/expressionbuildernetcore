using ExpressionBuilderNetCore.Builders;
...
namespace ExpressionBuilderNetCore.Generics
{
    ...
    public class Filter<TClass> : IFilter, IXmlSerializable where TClass : class
    {
        ...
        /// (To be used by <see cref="ICondition" /> that need no values)
        /// </summary>
        ...
        /// <returns></returns>
        public IFilterStatementConnection By(string propertyId, ICondition operation, Connector connector)
        {
        ...
        /// <param name="operation">Operation to be used.</param>
        /// <returns></returns>
        public IFilterStatementConnection By(string propertyId, ICondition operation)
        {
        ...
        /// <returns></returns>
		public IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value)
        {
        ...
        /// <param name="connector"></param>
        /// <returns></returns>
		public IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, Connector connector)
        {
        ...
        /// <param name="value2"></param>
        /// <returns></returns>
		public IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, TPropertyType value2)
        {
        ...
        /// <param name="connector"></param>
        /// <returns></returns>
		public IFilterStatementConnection By<TPropertyType>(string propertyId, ICondition operation, TPropertyType value, TPropertyType value2, Connector connector)
        {
